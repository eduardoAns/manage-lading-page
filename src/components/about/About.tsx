    ...
    <section id='about' className="h-screen w-full lg:h-screen-3/4">
      <div className=' h-full w-full flex flex-col justify-around items-center px-6 lg:justify-start lg:gap-16'>
        ...
        <div className=' gap-4 hidden lg:flex'>
          <article className=' w-96 h-64 flex flex-col items-center justify-evenly bg-secondary-400 lg:w-[28rem]'>
          ...
          <article className='hidden w-96 h-64 lg:flex flex-col items-center justify-evenly bg-secondary-400 lg:w-[28rem]'>
            <div className='h-16 mt-[-3.5rem]'>
              <img src='images/avatar-ali.png' className='h-full'/>
            </div>
            <h1 className=' font-bold b'>Ali Bravo</h1>
          ...
          <article className='hidden w-96 h-64 xl:flex flex-col items-center justify-evenly bg-secondary-400 lg:w-[28rem]'>
            <div className='h-16 mt-[-3.5rem]'>
              <img src='images/avatar-ali.png' className='h-full'/>
            </div>
            <h1 className=' font-bold b'>Ali Bravo</h1>
